...
/** @type {string} */
const CACHE_VERSION = '1783035271|13998258207';
/** @type {string} */
const CACHE_PREFIX = 'Waterdle-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Waterdle.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Waterdle.html","Waterdle.js","Waterdle.offline.html","Waterdle.icon.png","Waterdle.apple-touch-icon.png","Waterdle.audio.worklet.js","Waterdle.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Waterdle.wasm","Waterdle.pck"];
